...
public class job_book extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_job_book);
        search=(Button)findViewById(R.id.search_bookid);
        all_book=(Button)findViewById(R.id.allbookid);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.search_bookid) {
            SQLiteDatabase sqLiteDatabase = database.getWritableDatabase();
            Cursor cursor = database.display_job_search_book(name);
        ...
        if (view.getId() == R.id.allbookid) {
            SQLiteDatabase sqLiteDatabase = database.getWritableDatabase();
            Cursor cursor = database.display_job_book();
            if (cursor.getCount()==0) {
                showdata("Error", "Np data found");
        ...
        {
            Intent intent=new Intent(job_book.this,MainActivity.class);
        ...
        {
            Intent intent=new Intent(job_book.this,Books.class);
            startActivity(intent);
        }
    }
