...
public class add_eng_book extends AppCompatActivity implements View.OnClickListener {
    Button add,home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_eng_book);
    ...
    public void onClick(View view) {
        ...
        {
            long rowid=database.insert_Eng_book(name,writer,price);
            if(rowid==-1)
            {
        ...
        {
            Intent intent=new Intent(add_eng_book.this,MainActivity.class);
