...
public class add_job_book extends AppCompatActivity implements View.OnClickListener {
    Button add,home;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_job_book);
    ...
    public void onClick(View view) {
        ...
        {
            long rowid=database.insert_job_book(name,writer,price);
            if(rowid==-1)
            {
        ...
        {
            Intent intent=new Intent(add_job_book.this,MainActivity.class);
