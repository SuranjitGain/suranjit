...
public class buy_eng_book extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buy_eng_book);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.buy_book_id) {
            SQLiteDatabase sqLiteDatabase = database.getWritableDatabase();
            Cursor cursor = database.buy_eng_book(id);
        ...
        {
            Intent intent=new Intent(buy_eng_book.this,MainActivity.class);
