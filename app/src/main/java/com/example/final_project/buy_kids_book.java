...
public class buy_kids_book extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buy_kids_book);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.buy_book_id) {
            SQLiteDatabase sqLiteDatabase = database.getWritableDatabase();
            Cursor cursor = database.buy_kids_book(id);
        ...
        {
            Intent intent=new Intent(buy_kids_book.this,MainActivity.class);
