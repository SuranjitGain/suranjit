...
public class literature_book extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_literature_book);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.search_bookid) {
            SQLiteDatabase sqLiteDatabase = database.getWritableDatabase();
            Cursor cursor = database.display_literature_search_book(name);
        ...
        if (view.getId() == R.id.allbookid) {
            SQLiteDatabase sqLiteDatabase = database.getWritableDatabase();
            Cursor cursor = database.display_literature_book();
            if (cursor.getCount()==0) {
                showdata("Error", "Np data found");
        ...
        {
            Intent intent=new Intent(literature_book.this,MainActivity.class);
        ...
        {
            Intent intent=new Intent(literature_book.this,Books.class);
            startActivity(intent);
        }
    }
