...
public class buy_job_book extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buy_job_book);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.buy_book_id) {
            SQLiteDatabase sqLiteDatabase = database.getWritableDatabase();
            Cursor cursor = database.buy_job_book(id);
        ...
        {
            Intent intent=new Intent(buy_job_book.this,MainActivity.class);
