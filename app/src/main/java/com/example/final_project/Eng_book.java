...
public class Eng_book extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eng_book);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.search_bookid) {
            SQLiteDatabase sqLiteDatabase = database.getWritableDatabase();
            Cursor cursor = database.display_eng_search_book(name);
        ...
        if (view.getId() == R.id.allbookid) {
            SQLiteDatabase sqLiteDatabase = database.getWritableDatabase();
            Cursor cursor = database.display_eng_book();
            if (cursor.getCount()==0) {
                showdata("Error", "Np data found");
        ...
        {
            Intent intent=new Intent(Eng_book.this,MainActivity.class);
        ...
        {
            Intent intent=new Intent(Eng_book.this,Books.class);
            startActivity(intent);
        }
    }
